...
public class checkUserAvailability extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            String incomingUsername = request.getParameter("sendUsername");
            ...
            try {
                            ...
                            //String usernameAvailable = "test";
                            ResultSet resultSet = statement.executeQuery("select * from userDatabase.userTable where username = '" + incomingUsername + "';");
            ...
            //usernameAvailable = "This is a test.";
            //out.println(usernameAvailable);
